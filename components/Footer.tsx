      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col md:flex-row justify-between items-start gap-12 mb-20">
          ...
          <div className="flex flex-col gap-6 md:max-w-xs">
            ...
            <button 
              ...
              className="mt-2 bg-brand-dark text-white px-8 py-3.5 rounded-full text-sm font-semibold hover:bg-brand-dark/90 transition-all self-start shadow-sm cursor-pointer"
            >
              Get in Touch
            </button>
          </div>
        ...
        <div className="pt-8 border-t border-dark-gray/10 flex flex-col md:flex-row justify-between items-center gap-6 text-sm text-dark-gray/50">
          ...
          <div className="flex gap-8">
            <Link href="/privacy" className="hover:text-brand-dark transition-colors font-medium">Privacy Policy</Link>
          </div>
        </div>
      </div>
    </footer>
